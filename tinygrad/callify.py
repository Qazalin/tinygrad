...
def remove_contiguous_reshape_after(r:UOp, c:UOp, flatten_deps=False):
  a = r
...
pm_early_transform_tensor_graph = PatternMatcher([
  ...
  # a chain of reshapes on a contiguous AFTER is also a view of the target buffer
  (UPat(Ops.CONTIGUOUS, src=(UPat(Ops.RESHAPE, name="r"),), name="c"),
   remove_contiguous_reshape_after),
