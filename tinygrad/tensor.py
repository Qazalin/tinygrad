...
def _precompiled_output_redirect(s:UOp, t:UOp) -> tuple[UOp, dict[UOp, UOp]]|None:
  ...
  # A full-buffer reshape is the same storage with a different logical shape. Rebind both the returned view and
  # the producer's base, preserving the producer dependency without materializing a copy.
