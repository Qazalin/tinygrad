...
from tinygrad.helpers import all_same, dedup, prod, all_int
...
buffer_spec = PatternMatcher([
  ...
  (UPat(Ops.BUFFER_VIEW, src=(UPat(Ops.BUFFER),), name="v"), lambda v: isinstance(v.arg, tuple) and len(v.arg) == 3),
])
