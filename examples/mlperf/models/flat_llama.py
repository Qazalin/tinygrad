...
class FlatTransformer:
  ...
  def attention(self, x:Tensor, freqs_cis:Tensor, residual:Tensor|None=None, *, attention_norm:Tensor, wqkv:Tensor, wo:Tensor,
    ...
    if residual is None:
      ...
      xqkv, h, x_normed, rrms, s = add_norm_quantize_matmul(x, residual, attention_norm, wqkv, s_qkv, self.norm_eps,
