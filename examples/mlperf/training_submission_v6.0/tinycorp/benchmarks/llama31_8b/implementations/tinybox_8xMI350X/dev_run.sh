...
export MXFP4_FPROP=${MXFP4_FPROP:-1}
export MXFP4_DGRAD=${MXFP4_DGRAD:-1}
export MXFP4_WGRAD=${MXFP4_WGRAD:-1}
export MXFP4_HADAMARD=${MXFP4_HADAMARD:-1}
...
export DEFAULT_FLOAT="bfloat16" OPTIM_DTYPE=${OPTIM_DTYPE:-"float32"}
