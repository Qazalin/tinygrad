...
REMU_PATHS = ["libremu.so", "extra/remu/target/release/libremu.so", "/usr/local/lib/libremu.so", "libremu.dylib",
              "extra/remu/target/release/libremu.dylib", "/usr/local/lib/libremu.dylib", "/opt/homebrew/lib/libremu.dylib"]
