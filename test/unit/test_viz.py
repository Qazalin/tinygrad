...
class TestVizProfiler(unittest.TestCase):
  ...
  def test_perfetto_graph(self):
    ...
    nv_graph_events = j['layout']['NV Graph']['timeline']['shapes']
    self.assertEqual(nv_graph_events[0]['name'], 'batched 2')
    self.assertEqual(nv_graph_events[0]['dur'], nv1_events[0]['dur']+nv_events[0]['dur'])
