...
#ifdef STANDARD_FA_GRADS
  gl<bf16, -1, -1, -1, -1> dqg{const_cast<bf16*>(dq), ATTN_B, ATTN_N, ATTN_H, ATTN_D};
  gl<bf16, -1, -1, -1, -1> dkg{const_cast<bf16*>(dk), ATTN_B, ATTN_N, ATTN_H_KV, ATTN_D};
  gl<bf16, -1, -1, -1, -1> dvg{const_cast<bf16*>(dv), ATTN_B, ATTN_N, ATTN_H_KV, ATTN_D};
#else
...
#ifdef STANDARD_FA_GRADS
    load<1>(partial, src, {b, n_tile, kvh, 0});
