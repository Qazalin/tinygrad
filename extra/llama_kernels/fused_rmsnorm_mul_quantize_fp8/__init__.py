...
def fused_rmsnorm_mul_quantize_fp8(x:Tensor, weight:Tensor, amax_state:Tensor, eps:float, fp8_dtype, inv_scale_out:Tensor|None=None) -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor]:
  ...
  if inv_scale_out is None: inv_scale_out = alloc_local((), dtypes.float32, x.device, axis)
...
def fused_add_rmsnorm_mul_quantize_fp8(x:Tensor, residual:Tensor, weight:Tensor, amax_state:Tensor,
                                       eps:float, fp8_dtype, inv_scale_out:Tensor|None=None) -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor, Tensor]:
