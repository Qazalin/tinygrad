...
def fused_quantize_fp8_w13(xw13:Tensor, amax_state:Tensor, fp8_dtype, grad_amax_state:Tensor) -> tuple[Tensor, Tensor, Tensor]:
  ...
  fxn = _custom_fused_cast_amax_w13_uop if USE_UOP else functools.partial(_custom_fused_cast_amax_w13, dname=dname_of(xw13.device))
