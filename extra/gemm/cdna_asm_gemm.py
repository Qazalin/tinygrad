...
def custom_mxfp4_gemm(C:UOp, A:UOp, B:UOp, scale_a:UOp, scale_b:UOp, *extra:UOp, tile_m:int, tile_n:int) -> UOp:
  ...
  shortk = (M, N, K) == (16384, 4096, 4096) and (tile_m, tile_n) == (256, 256)
  num_threads = 256
  ...
  if shortk:
    from extra.gemm.mxfp4_gemm_rolling import build_kernel as build_shortk, get_launch_config, LDS_BYTES
